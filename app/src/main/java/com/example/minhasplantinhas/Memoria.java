...
public class Memoria extends MinhasPlantas{
    ...
    //Dados cardview
    static final ArrayList<String> nomeDasPlantas = new ArrayList<String>(Arrays.asList("Antúrio", "Comigo-ninguém-pode", "Dracena", "Espada-de-são-jorge", "Imbé", "Lírio da Paz", "Orquídea", "Samambaia"));
    static final ArrayList<String> especiesDasPlantas = new ArrayList<String>(Arrays.asList("Anthuriums andraeanum", "Dieffenbacchia", "Dracaenas Massangeana", "Sansevieria trifasciata", "Philodendrons", "Spathiphyllum wallisi", "várias espécies", "várias espécies"));
    static final ArrayList<String> txtAgua = new ArrayList<String>(Arrays.asList("Umida", "Umida", "Umida", "Umida", "Muita", "Umido", "Pouca", "Umida"));
    static final ArrayList<String> txtLuz = new ArrayList<String>(Arrays.asList("Manhã e Quente", "Tarde", "Pouca Luz", "Manhã e tarde", "Manhã e Tarde", "Morno", "Manhã", "Manhã e Quente"));
    static final ArrayList<String> txtAmbiente = new ArrayList<String>(Arrays.asList("Sombra", "Meia-Sombra", "Doméstico", "Externo", "Externo", "Doméstico", "Doméstico", "Doméstico"));
    //Imagem
    static final ArrayList<Integer> imagemPlanta = new ArrayList<Integer>(Arrays.asList(R.drawable.anturios,R.drawable.comigo_ninguem_pode,R.drawable.dracena,R.drawable.espada_sao_jorge,R.drawable.imbe,R.drawable.lirio,R.drawable.orquidea,R.drawable.samambaia));
    static final ArrayList<Integer> imagemLuz = new ArrayList<Integer>(Arrays.asList(R.drawable.sun_color,R.drawable.sun_color,R.drawable.night,R.drawable.sun_color,R.drawable.sun_color,R.drawable.sun_color,R.drawable.sun_color,R.drawable.sun_color));


    //dados detalhes
    static final ArrayList<String> listaResumo = new ArrayList<String>(Arrays.asList("Os Antúrios são uma das plantas mais utilizadas em ambientes internos devido as suas folhas brilhantes e flores bonitas. Se bem cuidadas, podem ser mantidas floridas o ano todo.", "Originária da Colômbia e da Costa Rica, a planta é cercada por mitos e crenças: acredita-se que ela seja capaz de afastar as energias negativas.", "A Dracena é uma planta que se desenvolve bem em ambientes internos. Perfeita para escritórios e aceita ser negligênciada um pouco.", "A espada-de-são-jorge é uma planta resistente que tem folhas compridas e largas. Graças à sua adaptabilidade e tolerância, ela é uma ótima planta para qualquer ambiente.", "O imbé é uma planta tropical que cresce de forma invasiva. Isto é, ela necessita de uma haste para seu crescimento, a fim de abarcar uma grande área, mas sempre à sombra de algum objeto, seja um muro ou mesmo uma outra árvore. Por isso, o imbé gosta muito de crescer ao lado de algum suporte.", "Bonitos e fáceis de cuidar, os lírios da paz são algumas das plantas caseiras mais populares. Basta tratar bem deles e você terá uma flor maravilhosa em casa por vários e vários anos", "As orquídeas são verdadeiras aliadas para a decoração. São espécies delicadas e muito charmosas, capazes de se adaptar bem em vários ambientes. E com os cuidados certos é possível manter a saúde da planta por um longo tempo.", "As samambaias, ou fetos, possuem tecidos vasculares, folhas verdadeiras, se reproduzem através de esporos e não produzem sementes ou flores.\n" +
